;(function(){
  ...
  // FILL THIS ENDPOINTS
const GET_ALL_USERS     = `https://swmh7d0rng.execute-api.us-east-1.amazonaws.com/dev/user/all`
const POST_NEW_USER     = `https://swmh7d0rng.execute-api.us-east-1.amazonaws.com/dev/user/create`;
const DELETE_DEL_USER   = `https://swmh7d0rng.execute-api.us-east-1.amazonaws.com/dev/user`
// FILL THIS ENDPOINST
